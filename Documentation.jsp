...
<html dir="ltr" lang="fr" xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="textzone">
			...
			<h1>Welcome to Saint Petersburg Corpus of Hagiographic Texts</h1>
			...
			<p>
				...
				<ul>
					...
					<li>
						display <a class="command" command="lexicon" path="/SCAT2021">the complete frequency list of word forms</a>
						<br />
						<br />
						<b>Concordance</b>
			</li>
			<li>
				<p>display <a class="command" command="concordance" path="/SCAT2021"
					query='[word = "бо?г..?"]'>a concordance of the word : “богъ”</a>
							(double-click on a concordance line to display the occurrence in the full context) ;</p>
					</li>
<!--					<li>
						<p>
							of a phrase : <a class="command" command="concordance" path="/SCAT2021"
								query='[lemma = "droit" & pos="ADJ"] [pos="NOM*"]'>un adjectif « droit » suivi d'un nom</a>.
						</p>
					</li>-->
				</ul>
			</li>				</ul>
			...
			<!--<p>
				Veuillez nous
				<a
					href="mailto:textometrie@groupes.renater.fr?subject=[txm%20demo%20portal]%20VOEUX%20corpus&body=%20">contacter</a>
